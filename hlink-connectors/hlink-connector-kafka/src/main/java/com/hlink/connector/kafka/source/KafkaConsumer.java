...
public class KafkaConsumer extends FlinkKafkaConsumer<RowData>{
    ...
    private transient ListState<FormatStateHelper> unionOffsetStates;
    private static final String LOCATION_STATE_NAME = "data-sync-location-states";
    private Map<Integer,FormatStateHelper> formatStateMap;
    ...
    public void snapshotState(FunctionSnapshotContext context) throws Exception {
        ...
        FormatStateHelper formatState = ((DynamicKafkaDeserializationSchemaWrapper) deserializationSchema).getFormatState();
        if (formatState != null){
