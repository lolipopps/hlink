...
public abstract class FlinkKafkaConsumerBase<T> extends RichParallelSourceFunction<T>
     ...
     * org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase#open(Configuration)} since it depends on whether or not checkpointing
     ...
     */
    public org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase<T> assignTimestampsAndWatermarks(
     ...
     * @return The consumer object, to allow function chaining.
     */
    public org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase<T> setCommitOffsetsOnCheckpoints(boolean commitOnCheckpoints) {
     ...
     * @return The consumer object, to allow function chaining.
     */
    public org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase<T> setStartFromEarliest() {
     ...
     * @return The consumer object, to allow function chaining.
     */
    public org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase<T> setStartFromLatest() {
     ...
     * @return The consumer object, to allow function chaining.
     */
    public org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase<T> setStartFromTimestamp(long startupOffsetsTimestamp) {
        checkArgument(
     ...
     * @return The consumer object, to allow function chaining.
     */
    public org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase<T> setStartFromGroupOffsets() {
     ...
     * org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase#setStartFromGroupOffsets()}) for that particular partition.
     *
     ...
     * @return The consumer object, to allow function chaining.
     */
    public org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase<T> setStartFromSpecificOffsets(
     ...
     * @return The consumer object, to allow function chaining.
     */
    public org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase<T> disableFilterRestoredPartitionsWithSubscribedTopics() {
