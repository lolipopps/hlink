...
package com.hlink.metrics;


import com.hlink.utils.ExceptionUtil;
import com.hlink.utils.ReflectionUtils;
...
public class AccumulatorCollector {
    ...
    public void collectAccumulator(){
        CompletableFuture<ExecutionGraphInfo> archivedExecutionGraphFuture = gateway.requestJob(Time.seconds(10));
        ...
        StringifiedAccumulatorResult[] accumulatorResult = archivedExecutionGraph.getArchivedExecutionGraph().getAccumulatorResultsStringified();
