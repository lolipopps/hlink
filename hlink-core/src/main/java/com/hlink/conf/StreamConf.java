...
public class StreamConf implements Serializable {
     ...
     */
    public static StreamConf parseJob(String jobJson){
        StreamConf config = GsonUtil.GSON.fromJson(jobJson, StreamConf.class);
        checkJob(config);
        return config;
    }
     ...
     */
    private static void checkJob(StreamConf config) {
