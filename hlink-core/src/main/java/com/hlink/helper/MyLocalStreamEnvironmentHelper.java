...
@Public
@Slf4j
public class MyLocalStreamEnvironmentHelper extends StreamExecutionEnvironment {
     ...
     */
    public MyLocalStreamEnvironmentHelper() {
     ...
     */
    public MyLocalStreamEnvironmentHelper(@Nonnull Configuration configuration) {
