...
import com.hlink.enums.PluginLoadMode;
import com.hlink.utils.SampleUtils;
...
import static com.hlink.constants.ConfigConstant.SAMPLE_INTERVAL_COUNT;
...
public class ExecuteProcessHelper {
    ...
    public static boolean checkRemoteSqlPluginPath(String remoteSqlPluginPath, String deployMode, String pluginLoadMode) {
        if (StringUtils.isEmpty(remoteSqlPluginPath)) {
            return StringUtils.equalsIgnoreCase(pluginLoadMode, PluginLoadMode.SHIPFILE.name())
