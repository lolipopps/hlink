...
public class SampleUtils {
    ...
    public static void samplingSourcePrint(int samplingIntervalCount, long count, String message) {
        Runnable func = () ->log.info("sampling source input data: " + message);
        samplingPrint(samplingIntervalCount, count, func);
    }

    public static void samplingSinkPrint(int samplingIntervalCount, long count, String message) {
        Runnable func = () -> log.info("sampling sink output data: " + message);
        samplingPrint(samplingIntervalCount, count, func);
    }

    public static void samplingDirtyPrint(int samplingIntervalCount, long count, String message) {
        Runnable func = () -> log.info("sampling dirty output data: " + message);
        samplingPrint(samplingIntervalCount, count, func);
    }
