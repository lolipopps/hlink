...
public class DTThreadFactoryUtil implements ThreadFactory {
    ...
    public DTThreadFactoryUtil(String factoryName) {
    ...
    public DTThreadFactoryUtil(String factoryName, Boolean isDaemon) {
        SecurityManager s = System.getSecurityManager();
        group = (s != null) ? s.getThreadGroup() :
                Thread.currentThread().getThreadGroup();
        namePrefix = factoryName + "-pool-" +
